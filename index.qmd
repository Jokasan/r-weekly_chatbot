...
format:
    html:
        ...
        code-links:
          - text: GitHub
            icon: github
            href: https://github.com/Jokasan/r-weekly_chatbot
execute:
    eval: false
    echo: true
---
...
This project demonstrates how to build an AI-powered chatbot that answers questions about the R Weekly Highlights podcast content using Retrieval Augmented Generation (RAG). The application allows users to query transcripts from the R Weekly Highlights podcast through a conversational interface. The idea came to me after listening to episode 217, where [Yann Tourman's episode length analysis](https://bsky.app/profile/yannco.bsky.social/post/3mbarm75kik2j) was shouted out. I thought this would be a great use case to apply the [Retrieval-Augmented Generation: Setting up a Knowledge Store in R](https://www.jumpingrivers.com/blog/retrieval-augmented-generation-database-workflow-r/), in practice! [You can check out the resulting Shiny app here](https://jokasan-r-weekly-chatbot.share.connect.posit.cloud). The full source code is available on [GitHub](https://github.com/Jokasan/r-weekly_chatbot). So without further ado let's begin!
